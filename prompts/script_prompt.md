...
- SAYILAR: Tüm sayıları rakamla değil YAZIYLA yaz ("90" değil "ninety",
  ...
  ediyor, yazıyla yazmak bunu önlüyor.
- KISALTMALAR: Herhangi bir kısaltma/kurum adı (ESRB, NASA, CPU gibi) ilk
  geçtiği yerde MUTLAKA açık haliyle birlikte ver ("the Entertainment
  Software Rating Board, or ESRB," gibi). Sonraki kullanımlarda kısaltma
